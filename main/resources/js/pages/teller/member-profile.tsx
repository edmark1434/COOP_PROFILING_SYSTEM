...
export default function TellerMemberProfile({
    member,
    delinquencyRate = 0,
    transactionsAscName,
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: `Member ${member.id}`, href: `/teller/member-lookup/${member.id}` },
    ];
    ...
    console.log('Data being passed to ProfileCard:', memberWithDelinquencyRate);
