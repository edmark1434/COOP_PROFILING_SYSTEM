...
import {headerConfigs} from "@/layouts/app/header-config";
...
export function AppSidebarHeader({
    ...
    const { url } = usePage()
    const match = Object.entries(headerConfigs).find(([path]) => url.startsWith(path))
    const actions = match ? match[1] : null
