...
interface TellerTransactionRowProps extends React.ComponentProps<"div"> {
    data? : any
}

export function TellerTransactionRow({
                                        data,
                                        className,
                                        ...props
                                    }: TellerTransactionRowProps) {
    return (
        <div
            data-slot="teller-transaction-row"
            className={cn(
